...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a  href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="btn btn-primary shadow-md mr-2">Tambah Service</a>
        <div class="dropdown">
...
>>>>>>> 379c219e984061913da957501ddb431bba7ba446
        ...
        <div class="modal-content">
            ...
            <form  method="post" id="form_edit" onsubmit="return false;" enctype="multipart/form-data">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <input type="hidden" class="id_service" id="id_service" name="id_service" >
        ...
        swalWithTailwindpButtons.fire({
            ...
            reverseButtons: true
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url         : "{{URL::to('datamaster/service')}}/"+id,
                        type        : 'delete',
                        contentType : false,
                        cache       : false,
                        processData : false,
...
if($("#form_edit")[0].checkValidity()) {
    ...
    e.preventDefault();
    $.ajax({
        url         : "{{URL::to('datamaster/service-update')}}",
        type        : 'POST',
        data        : data,
        dataType    : 'JSON',
        contentType : false,
