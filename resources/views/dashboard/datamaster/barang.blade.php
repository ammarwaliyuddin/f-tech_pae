...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a  data-toggle="modal" data-target="#add-item-modal" class="btn btn-primary shadow-md mr-2">Tambah Barang</a>
        <div class="dropdown">
        ...
        <table class="table table-report -mt-2" id="myTabel">
            <thead>
                <tr>
                    ...
                    <th class="whitespace-nowrap">Jenis Barang</th>
...
<script>
    ...
    function showData(){
        ...
        $.ajax({
            url:"{{URL::to('datamaster/barang-list')}}",
            type:"GET",
            data:data,
            // beforeSend:function(){
        ...
        swalWithTailwindpButtons.fire({
            ...
            reverseButtons: true
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url         : "{{URL::to('datamaster/barang')}}/"+id,
                        type        : 'delete',
                        contentType : false,
                        cache       : false,
                        processData : false,
