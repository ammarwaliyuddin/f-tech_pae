...
<div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
    ...
    <table class="table table-report -mt-2">
        <thead>
            <tr>
                <th class="text-center whitespace-nowrap" style="width: 6%;">No</th>
        ...
        <tbody>
            ...
            <tr class="intro-x text-center">
                ...
                <td><a href="" class="font-medium whitespace-nowrap ">{{ $item->disposisi->nama_disposisi }}</a></td>
