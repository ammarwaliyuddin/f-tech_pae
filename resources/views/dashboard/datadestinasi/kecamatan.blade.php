...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <button class="btn btn-primary shadow-md mr-2">Tambah Kecamatan</button>
        <div class="dropdown">
            ...
            <tbody>
                ...
                @for ($i = 1; $i <= $data; $i++) --}}
                    <tr class="intro-x">
                        ...
                        <td><a href="" class="font-medium whitespace-nowrap">Alak</a></td>
                        <td class="text-center">Kupang</td>
                    ...
                    <tr class="intro-x">
                        ...
                        <td><a href="" class="font-medium whitespace-nowrap">Oebobo</a></td>
                        <td class="text-center">Kupang</td>
                        <td class="text-center"></td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                    ...
                    <tr class="intro-x">
                        ...
                        <td><a href="" class="font-medium whitespace-nowrap">Kelapa Lima</a></td>
                        <td class="text-center">Kupang</td>
                        <td class="text-center"></td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                    ...
                    <tr class="intro-x">
                        ...
                        <td><a href="" class="font-medium whitespace-nowrap">Maulafa</a></td>
                        <td class="text-center">Kupang</td>
                        <td class="text-center"></td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                    ...
                    <tr class="intro-x">
                        ...
                        <td><a href="" class="font-medium whitespace-nowrap">Kota Lama</a></td>
                        <td class="text-center">Kupang</td>
                        <td class="text-center"></td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
