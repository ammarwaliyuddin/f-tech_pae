...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <button class="btn btn-primary shadow-md mr-2">Tambah Level</button>
        <div class="dropdown">
        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    ...
                    <th class="whitespace-nowrap">Bonus</th>
            ...
            <tbody>
                ...
                @for ($i = 1; $i <= $data; $i++) --}}
                    <tr class="intro-x">
                        <td class="w-20">
                            <a href="" class="font-medium whitespace-nowrap">{{ 1 }}</a> 
                        </td>
                        <td>
                            <a href="" class="font-medium whitespace-nowrap">Pegawai</a> 
                        </td>
                        <td class="text-center">Rp 10.000</td>
                        <td class="text-center">Level untuk pelanggan yang bersatus Pegawai</td>
                    ...
                    <tr class="intro-x">
                        <td class="w-20">
                            <a href="" class="font-medium whitespace-nowrap">{{ 2 }}</a> 
                        </td>
                        <td>
                            <a href="" class="font-medium whitespace-nowrap">Mitra perusahaan</a> 
                        </td>
                        <td class="text-center">Rp 13.000</td>
                        <td class="text-center">Level untuk pelanggan yang bersatus mitra perusahaan</td>
